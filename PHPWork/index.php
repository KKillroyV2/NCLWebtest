			...
			<div class="wrap-login100">
				<form class="login100-form validate-form"  method="GET" action="index.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						...
						<input type="text" class="input100" name="email" id="Email">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<input type="password" class="input100" name="pass" id="Password">
...
{	 
		$servername = "localhost";
          ...
          $sql = "SELECT * FROM users where Email = '$emailed' and Password = '$passored'";
          ...
          if (mysqli_num_rows($result) > 0) {
			...
			//  echo  $_GET['pass'];				    					                               
			   echo'<script> window.location="/web/PHPwork/AfterLogin/index.html"; </script> ';
			   exit;
          } else {
              //echo "0 results";
			  echo "<script> alert('Incorrect Username / Passwrod'); </script>";
					exit;
          }
